...
/*
=========================================
TODO CLEANUP NFOP 3.2 — legacy BUILD 001 render*
Zastąpione przez app.js. Poniższe funkcje nieużywane.
=========================================
*/
...
/* renderProjects() — zdefiniowane w app.js */

function renderHeader(projectCount) {
  return `
    <div class="card">
      <h2>Aktive Projekte</h2>
      <p>${projectCount} Projekte</p>
...
// TODO CLEANUP NFOP 3.2 — duplikat formatEventAddress z app.js
...
function renderAddress(project) {
...
function renderWorkflow(project){
    ...
    const nextStep =
        ...
        : `👉 Jetzt: ${
            project.tasks.find(task => !task.done)?.label
        }`;
